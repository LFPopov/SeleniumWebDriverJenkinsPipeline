...
namespace TestProject2
{
    ...
    public class WorkingWithWebTable
    {
        ...
        public void SetUp()
        {
			...
			options.AddArgument("remote-debugging-port=922");
        ...
        public void TestExtractProductInformation()
        {
            ...
            ClassicAssert.IsTrue(File.Exists(path), "CSV file was not created");
            ClassicAssert.IsTrue(new FileInfo(path).Length > 0, "CSV file is empty");
        }
